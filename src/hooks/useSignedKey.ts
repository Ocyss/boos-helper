...
logger.debug(import.meta.env)

export const client = createClient<paths>({ baseUrl: (import.meta.env.PROD || import.meta.env.TEST || import.meta.env.WXT_TEST) ? 'https://boss-helper.ocyss.icu' : 'http://localhost:8002' })
