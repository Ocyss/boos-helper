...
export const store: Record<string, [() => JSX.Element, string, string]> = {
  chrome: [ChromeStore, 'Chrome Store, 需要魔法，审核速度较慢', 'https://chromewebstore.google.com/detail/ogkmgjbagackkdlcibcailacnncgonbn?authuser=1&hl=zh-CN'],
  crx: [CrxStore, '国内Chrome用户推荐，Chrome 同步无需魔法，更新速度未知', 'https://www.crxsoso.com/webstore/detail/ogkmgjbagackkdlcibcailacnncgonbn'],
  edge: [EdgeStore, 'Edge浏览器用户推荐，除了更新慢一些。审核速度最慢', 'https://microsoftedge.microsoft.com/addons/detail/jcllnbjfeamhihjpfjlclhdnjmggbgal'],
  firefox: [FirefoxStore, 'Firefox 浏览器用户，无需魔法, 审核速度最快', 'https://addons.mozilla.org/zh-CN/firefox/addon/boos-helper/'],
  github: [Github, 'Github, 需要魔法，没有审核，随时更新', 'https://github.com/Ocyss/boos-helper/releases/latest'],
}
